...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20250306025218_alter image table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalks.API.Models.DTOs.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NZWalks.API.Models.DTOs.Domain.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Models.DTOs.Domain.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Models.DTOs.Domain.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Models.DTOs.Domain.Walk", b =>
                {
                    b.HasOne("NZWalks.API.Models.DTOs.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NZWalks.API.Models.DTOs.Domain.Region", "Region")
                        .WithMany()
